...
const CAREGIVERS = [
  {
    ...
    area_label: 'ลาดพร้าว', lat: 13.8161, lng: 100.5601, rate: 700, rate_unit: 'per_day',
  },
  {
    ...
    area_label: 'บางกะปิ', lat: 13.7657, lng: 100.6470, rate: 900, rate_unit: 'per_day',
  },
  {
    ...
    area_label: 'จตุจักร', lat: 13.8000, lng: 100.5530, rate: 600, rate_unit: 'per_day',
  },
  {
    ...
    area_label: 'รามคำแหง', lat: 13.7570, lng: 100.6445, rate: 1000, rate_unit: 'per_day',
  },
  {
    ...
    area_label: 'ดินแดง', lat: 13.7700, lng: 100.5540, rate: 550, rate_unit: 'per_day',
  },
];
    ...
    await conn.query(
      `UPDATE caregiver_profiles
          SET bio = ?, experience_years = ?, skills = ?,
              area_label = ?, lat = ?, lng = ?, rate = ?, rate_unit = ?,
              kyc_status = 'approved', kyc_submitted_at = NOW(), kyc_reviewed_at = NOW()
        WHERE user_id = ?`,
      [c.bio, c.experience_years, c.skills, c.area_label, c.lat, c.lng, c.rate, c.rate_unit, id]
    );
